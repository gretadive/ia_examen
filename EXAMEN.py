...
niveles = {
    "básico": [
        {
            "tipo": "opcion",
            "pregunta": "NIVEL BÁSICO: ¿Cuál es una ventaja de la evaluación formativa con IA?",
        ...
        {
            "tipo": "opcion",
            "pregunta": "NIVEL BÁSICO: ¿Qué permite la evaluación formativa?",
        ...
        {
            "tipo": "vf",
            "pregunta": "NIVEL BÁSICO: La evaluación formativa se usa únicamente al final del curso. (V/F)",
            "respuesta": "F",
        ...
        {
            "tipo": "abierta",
            "pregunta": "NIVEL BÁSICO: ¿Qué rol cumple el estudiante en la evaluación formativa?",
    ...
    "intermedio": [
        {
            "tipo": "opcion",
            "pregunta": "NIVEL INTERMEDIO: ¿Cómo puede usarse la IA para personalizar la enseñanza?",
        ...
        {
            "tipo": "opcion",
            "pregunta": "NIVEL INTERMEDIO: ¿Qué ventaja ofrece la analítica de aprendizaje con IA?",
        ...
        {
            "tipo": "vf",
            "pregunta": "NIVEL INTERMEDIO: La IA no puede detectar patrones de aprendizaje. (V/F)",
            "respuesta": "F",
            "explicacion": "La IA sí puede detectar patrones para personalizar la enseñanza."
        },
        {
            "tipo": "abierta",
            "pregunta": "NIVEL INTERMEDIO: ¿Qué herramienta con IA conoces que apoye la evaluación formativa?",
            "respuesta": ["chatgpt", "quizziz", "kahoot", "duolingo"],
            "explicacion": "Existen muchas herramientas con IA que brindan retroalimentación."
        },
        {
            "tipo": "abierta",
            "pregunta": "NIVEL INTERMEDIO: Menciona un beneficio de usar IA en la educación.",
    ...
    "avanzado": [
        {
            "tipo": "opcion",
            "pregunta": "NIVEL AVANZADO: ¿Cuál de los siguientes no es un riesgo ético de la IA en educación?",
        ...
        {
            "tipo": "opcion",
            "pregunta": "IVEL AVANZADO: ¿Cómo puede la IA ayudar a estudiantes con necesidades especiales?",
        ...
        {
            "tipo": "vf",
            "pregunta": "IVEL AVANZADO: La IA puede generar retroalimentación automática según el desempeño. (V/F)",
            "respuesta": "V",
            "explicacion": "Es una de sus funciones clave en evaluación formativa."
        },
        {
            "tipo": "abierta",
            "pregunta": "IVEL AVANZADO: Menciona un dilema ético del uso de IA en la educación.",
        ...
        {
            "tipo": "abierta",
            "pregunta": "IVEL AVANZADO: ¿Qué acciones puede tomar un docente al usar IA en la evaluación?",
...
def temporizador_visual():
    ...
    while True:
        ...
        tiempo_formateado = format_tiempo(tiempo_actual)
        st.sidebar.subheader(f"⏳ Temporizador: {tiempo_formateado}")
